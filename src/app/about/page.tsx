  ...
  return (
    <div className='container mx-auto px-6'>
      ...
      <p className='max-w-prose text-lg'>
        ...
        Every time I would take a picture, it would be blurry, uncentered, and nowhere near
        professional. Over the course of five years, I have developed the technique of photography;
        whether it be of cars, human subjects, or nature. Having just bought my first, {'very own'}
      ...
      <p className='max-w-prose text-lg mb-12'>
        ...
        taking a picture is intricate enough, but there is a lot behind behind the scenes that goes
        on to capture that vivid shot that we want to show our friends, family, and the whole world.
      </p>
    </div>
  );
};
